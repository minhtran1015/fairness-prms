...
pivot_data = df.pivot(index='category_vn', columns='temp_label', values='eodds_gap')
...
ax1.set_xlabel('Nhiệt Độ Sinh', fontsize=16)
...
plt.savefig('evaluation_output/eodds_gap_all_temps_comprehensive.png', 
            dpi=300, bbox_inches='tight')
plt.savefig('evaluation_output/eodds_gap_all_temps_comprehensive.pdf', 
            bbox_inches='tight')

print("✅ Biểu đồ tổng hợp EOdds Gap (Heatmap + Grouped Bar) đã được lưu!")
